...
#define CORE_CLOCK_SOURCE                                                     HFXO                                                                                             // set by target:EFR32MG12_BRD4161
#define HFRCO_FREQUENCY                                                       32000000                                                                                         // set by target:EFR32MG12_BRD4161
#define HFRCO_FREQUENCY_ENUM                                                  cmuHFRCOFreq_32M0Hz                                                                              // set by target:EFR32MG12_BRD4161
#define HFXO_FREQUENCY                                                        38400000                                                                                         // set by target:EFR32MG12_BRD4161
#define LFXO_FREQUENCY                                                        32768                                                                                            // set by target:EFR32MG12_BRD4161
#define LOW_ENERGY_CLOCK_SOURCE                                               LFXO                                                                                             // set by target:EFR32MG12_BRD4161
