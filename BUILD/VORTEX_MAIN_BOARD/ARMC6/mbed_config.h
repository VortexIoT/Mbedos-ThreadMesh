...
#define CORE_CLOCK_SOURCE                                                     HFXO                                                                                             // set by target:VORTEX_MAIN_BOARD
#define HFRCO_FREQUENCY                                                       32000000                                                                                         // set by target:VORTEX_MAIN_BOARD
#define HFRCO_FREQUENCY_ENUM                                                  cmuHFRCOFreq_32M0Hz                                                                              // set by target:VORTEX_MAIN_BOARD
#define HFXO_FREQUENCY                                                        38400000                                                                                         // set by target:VORTEX_MAIN_BOARD
#define LFXO_FREQUENCY                                                        32768                                                                                            // set by target:VORTEX_MAIN_BOARD
#define LOW_ENERGY_CLOCK_SOURCE                                               LFXO                                                                                             // set by target:VORTEX_MAIN_BOARD
...
#define MBED_CONF_APP_BUTTON                                                  BTN0                                                                                             // set by application[VORTEX_MAIN_BOARD]
#define MBED_CONF_APP_BUTTON_MODE                                             PullUp                                                                                           // set by application[VORTEX_MAIN_BOARD]
