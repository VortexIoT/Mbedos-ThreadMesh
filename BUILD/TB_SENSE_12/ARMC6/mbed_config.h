...
#define CORE_CLOCK_SOURCE                                                     HFXO                                                                                             // set by target:TB_SENSE_12
#define HFRCO_FREQUENCY                                                       32000000                                                                                         // set by target:TB_SENSE_12
#define HFRCO_FREQUENCY_ENUM                                                  cmuHFRCOFreq_32M0Hz                                                                              // set by target:TB_SENSE_12
#define HFXO_FREQUENCY                                                        38400000                                                                                         // set by target:TB_SENSE_12
#define LFXO_FREQUENCY                                                        32768                                                                                            // set by target:TB_SENSE_12
...
#define MBED_CONF_SL_RAIL_HAS_2P4                                             1                                                                                                // set by library:sl-rail[TB_SENSE_12]
